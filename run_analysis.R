...
#Combine these two dataframes into one called 'alldata'
...
#Now we can create a separate dataframe that takes the average for each variable sorted by activity and subject
